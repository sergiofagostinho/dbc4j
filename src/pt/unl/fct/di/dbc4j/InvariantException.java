...
/**
 * Exception used when a class invariant does not hold in a certain execution
 * context.
 * 
...
public class InvariantException extends ContractException {
	...
	/**
	 * Creates a new invariant exception.
	 * @param message The exception detailed message
	 */
	public InvariantException(String message) {
		super("Invariant failed during the execution of the '" + message

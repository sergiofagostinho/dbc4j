...
/**
 * Exception used when trying to evaluate an assertion with non-public,
...
public class InvalidVisibilityException extends RuntimeException {
	...
	public InvalidVisibilityException(String message) {
		super("Invalid visibility for '" + message
				+ "' assertion. Must be either a private or public method.");
	}
}
